...
function make_before(ci) {
    ...
    pdfHtml += '<div class="profile-block t1 pro40"><div class="flex-center p2 text-center w150"  style="width: 80px;"><p>住所</p></div><div class="profile-sub-block flex p2"><div><input id="zipCode" class="input2 w200" value="' + zipCode + '"><input id="adress" class="input2 w200" value="' + adress + '"><div style="display: flex; align-items: center"><span>Tel：</span><input id="phone" class="input2 w200" value="' + phone + '"></div></div></div><div class="flex-center p3"><img alt="stamp" id="stamp" src="' + stamp + '" style="height:70px; width:70px" /></div></div></div>';
