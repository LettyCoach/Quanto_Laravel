...
<head>
    ...
    <script>
    window.usetifulTags = { userId : "EXAMPLE_USER_ID", segment: "EXAMPLE_SEGMENT_NAME", language : "EXAMPLE_LANGUAGE_CODE", role : "EXAMPLE_ROLE", firstName : "EXAMPLE_NAME",     
    };</script>
...
$server_host = "http://192.168.113.30:9016/";
?>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TX99LKT"
    ...
    <div class="modal-content" style="border-radius: 20px;">
      <div class="modal-header" style="border: none;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><img src="<?php echo $server_host; ?>front/assets/img/close_cross_icon.png" width=32 height=32></span>
        </button>
      </div>
      ...
      <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-primary" data-dismiss="modal" onClick="handleSelectAnswer(MODAL_O.elm, MODAL_O.qID, MODAL_O.aID)">追加</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo $server_host; ?>api/v1/client/pdf" method="POST" enctype="multipart/form-data" target="_blank">
        ...
        <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-primary m-auto" style="background-color: #6962FF;">プレビュー</button>
        </div>
      </form>
    </div>
  </div>
    ...
    <footer>
        <img class="logo-img" src="" />
        <button type="button" id="prevBtn" class="btn btn-secondary footer-back" disabled onclick="nextPrev(-1)">戻る</button>
        <button type="button" id="nextBtn" class="btn btn-primary footer-next" disabled data-nextQuestion="" onclick="nextPrev(1)">次へ</button>
            ...
            <div class="footer-order-list">
                <div class="col h-100p pc" style="display: block !important;">
                    <div class="row title">
                        ...
                        <div class="col"><div class="footer-order-hide"></div></div>
                    </div>
                    <hr class="mb-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            <button type="button" class="btn btn-primary m-auto" data-toggle="modal" data-target="#previewModal">プレビュー</button>
                        </div>
                        <div class="col pc">
                            <div class="row m-0">
