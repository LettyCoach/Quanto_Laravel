...
<!-- Modal -->
<a href="#" id="exampleModalBtn" class="btn" data-toggle="modal" data-target="#exampleModal" style="display: none;">モーダル</a>
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width: fit-content; min-width: unset; margin: 25% auto;">
    <div class="modal-content" style="height: 300px; min-height: unset; width: 400px; border-radius: 30px; box-shadow: 3px 3px 0px 0px rgba(0, 0, 0, 0.3);">
                ...
                <div class="card-profile-image mt-4">
                    <form id="file-upload" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="profile_path">
                            <figure class="avatar font-weight-bold"
                ...
                <div class="card-profile-image mt-4">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <label for="stamp_path">
                            <figure class="font-weight-bold"
                                    style="font-size: 60px; height: 180px; width: 180px;" data-initial="Stamp">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="member">
                                            ...
                                            @foreach($members as $key => $item)
                                                <option value="{{ $item->name }}" {{ $member == $item->name ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="purpose">
                                            ...
                                            @foreach($purposes as $key => $item)
                                                <option value="{{ $item->name }}" {{ $purpose == $item->name ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="payment_method">
                                            ...
                                            @foreach($payment_methods as $key => $item)
                                                <option value="{{ $item->name }}" {{ $payment_method == $item->name ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.fn.exChange = function(callback, fn) {
                ...
                var func = fn || function(r) { return $(r).val(); };
