...
<div class="main_pan">
    ...
    <div class="row m-0 justify-content-center">
        <form class="" id="survey" method="post" action="{{ route('admin.userProductCategory.save') }}" enctype="multipart/form-data" onsubmit="return checkData()">
            <div class="form_pan" style="width: 720px">
                ...
                <input type = "hidden" name = "productes_all" id = "productes_all" value="{{ $model->getProductesAll() }}"/>
            </div>
        </form>
    </div>
</div>
