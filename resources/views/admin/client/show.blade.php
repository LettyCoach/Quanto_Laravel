        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="http://192.168.113.30:9016/admin/client/sendMail" method="POST" >
                        @csrf
                        <input type="hidden" name="id" value="{{ $client->id }}">
                        <div class="row m-5">
                            <div class="col-md-2">ユーザ名</div>
                            <div class="col-md-10"><input type="text" name="name" value="{{ $client->name }}" /></div>
                        </div>
                        <div class="row m-5">
                            <div class="col-md-2">メールアドレス</div>
                            <div class="col-md-10"><input type="text" name="email" value="{{ $client->email }}" /></div>
                        </div>
                        <div class="row m-5">
