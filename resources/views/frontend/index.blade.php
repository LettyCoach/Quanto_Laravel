...
<body style="background-color: <?php echo $query->background_color; ?>; color: <?php echo $query->char_color; ?>; min-height: 100vh">
    ...
    <div class="position-fixed" style="z-index: 1000;right:40px; top:30px">
        <button id="profileBtn" type="button" class="btn btn-quanto py-2 px-5"> @if (session('customer_id')) {{session('customer_name')}}さん @else ログイン @endif</button>
    ...
    <header id="header" class="header">
        <div class="site-header">
            <div class="site-header-inner">
                ...
                <div id="brand-desc" class="brand-desc" style="background-color: <?php echo $query->callout_color; ?>; color: <?php echo $query->char_color; ?>;">{{$query->brand_description}}</div>
                @endif
                <div id="title-desc" class="title-desc">
                    <h1 id="title" class="title"><span style="background-color: <?php echo $query->callout_color; ?>; color: <?php echo $query->char_color; ?>;">{{$query->title}}</span></h1>
                    <p id="description" class="description" style="background-color: <?php echo $query->callout_color; ?>; color: <?php echo $query->char_color; ?>;">{{$query->description}}</p>
                </div>
                <div id="btn-start" class="btn-start" style="background-color: <?php echo $query->callout_color; ?>; color: <?php echo $query->char_color; ?>;">START</div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content content position-relative  radius-top radius-bottom">
                <div class="modal-header border-bottom-0 position-absolute" style="z-index: 50;right:0">
                    <button type="button" class="btn-close bg-white p-3" data-bs-dismiss="modal" aria-label="Close" style="border-radius:50%;"></button>
                </div>
                        ...
                        <div class="counter py-2">
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <button type="button" class="quantity-left-minus btn btn-outline-primary btn-number" data-type="minus" data-field="">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="quantity-right-plus btn btn-outline-primary btn-number" data-type="plus" data-field="">
    ...
    <div class="modal fade" id="loginModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content radius-top radius-bottom" id="loginDiv" style="background:#DAE3F3; padding:30px">
                ...
                <div class="modal-body d-block">
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="email" class="form-control" id="loginEmail" name="loginEmail" placeholder="email@mydomain.com" required value="">
                        </div>
                    </div>
                    <div class="form-group row py-2">
            ...
            <div class="modal-content radius-top radius-bottom" id="resetDiv" style="background:#DAE3F3; padding:30px; display:none">
                <div class="modal-header border-bottom-0 position-absolute loginClose">
                    <button type="button" class="btn-close bg-white p-3" data-bs-dismiss="modal" aria-label="Close" style="border-radius:50%;"></button>
                </div>
                <div class="modal-header text-center border-2 border-white d-block">
                ...
                <div class="modal-body d-block">
                    ...
                    <div class="form-group row py-2">
                        <label for="email" class="col-sm-3 col-form-label">メールアドレス</label>
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="resetEmail" name="resetEmail" placeholder="email@mydomain.com" required value="">
                        </div>
                    </div>
                    ...
                    <div class="col-12" id="resetSuccess" style="display: none;">
                        <div class="alert alert-success alert-dismissible d-flex align-content-center mt-3" role="alert">
                ...
                <div class="modal-body d-block">
                    ...
                    <div class='row form-group py-2'>
                        <div class='col-xs-12 form-group required'>
                            ...
                            <input name="registerPassword" id="registerPassword" class='form-control' type='password'>
                    ...
                    <div class="col-12" id="registerError" style="display: none;">
                        <div class="alert alert-danger alert-dismissible d-flex align-content-center mt-3" role="alert" id="registerErrors">
                            入力情報に不備があります。
                            <button type="button" class="btn-close align-self-center me-2 d-none" style="top:auto" data-bs-dismiss="alert" aria-label="Close">
                            </button>
                        </div>
    ...
    <div class="container" id="body-content" style="max-width:1200px; display:none; margin:0 auto;">
                    ...
                    foreach ($query['answers'] as $key => $answer) {
                        if ($question->id == $answer->question_id) { ?>
                            <div class="col-6 col-lg-4 col-md-4 ">
                                <a class="pro-card load_content" data-survey="{{$query->id}}" data-id="{{$answer->id}}" data-title="{{$answer->title}}" data-image="{{$answer->file_url}}" data-price="{{$answer->value}}" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        ...
        <div class="row mx-3" style="position:fixed; bottom:50px; left:0; right:0;">
            <div class="col-2"> <button class="btn btn-quanto px-4 px-sm-5 text-nowrap py-2 float-start me-5" style="display:none" type="button" id="prevBtn" onclick="nextPrev(-1)">前へ</button></div>
            ...
            <div class="col-2">
                <button class="btn btn-quanto px-4 px-sm-5 text-nowrap py-2 float-end ms-5" type="button" id="nextBtn" onclick="nextPrev(1)">次へ</button>
                <button class="btn btn-quanto px-4 px-sm-5 text-nowrap py-2 float-end ms-5" style="display:none;" type="button" id="startBtn" onclick="firstTab()">戻る</button>
            </div>
        </div>
        ...
        <div class="total" id="total">
            ...
            <div class="row cart-item-list" id="item-list" style="max-width: 450px; margin: 0 auto; background-color: white; color: black; padding: 5px; border-radius: 13px; display: none">
                <a class="text-decoration-none text-center w-100 text-black-50 pt-2 close-cart" style="cursor:pointer;">
                    <h4>X</h4>
                </a>
            ...
            <div id="cart-info" class="row text-center item-line" style="max-width: 450px; margin: 0 auto; background-color: #6962FF; padding: 5px; border-radius: 13px">
                <div class="col">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".load_content").click(function() {
                ...
                $('.product-image').html('').prepend('<img class="product-image-full image radius-top" src="../' + $(this)
                    .data("image") + '" />');
